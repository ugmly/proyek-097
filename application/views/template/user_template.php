                ...
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link <?php echo $active_menu == 'home' ? 'active' : ''; ?>"
                            href="<?= site_url('beranda/dashboard') ?>">Film</a>
                    <!-- </li> -->
                    <!-- <!-- <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo $active_menu == 'Admin' ? 'active' : ''; ?>"
                            href="<?= site_url('Tiket/buy_tiket') ?>">Buy Tikets</a> 
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo $active_menu == 'usert' ? 'active' : ''; ?>"
                            href="<?= site_url('tentang/usert') ?>">Seat Information</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo $active_menu == 'history' ? 'active' : ''; ?>"
                            href="<?= site_url('History/history') ?>">History</a>
                    </li>
                </ul>
    ...
    <div class="container mt-5 mb-5">
        ...
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top border-2">
            <div class="col-md-4 d-flex align-items-center">
                ...
                <span class="text-muted">©2024 Praktikum TIF | 1412220097 | to user</span>
            </div>
        </footer>
    </div>
