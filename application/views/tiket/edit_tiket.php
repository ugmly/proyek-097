            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group mt-3">
                        ...
                        <input type="text" class="form-control" id="no_kursi" name="no_kursi" value="<?= $tiket['no_kursi']?>">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <select class="form-control" id="judul_film" name="judul_film">
                            <?php foreach ($judul_film_options as $option) : ?>
                                <option value="<?= $tiket['judul_film']; ?>" <?= set_select('judul_film', $option); ?>><?= $option; ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <select class="form-control" id="jadwal_tayang" name="jadwal_tayang">
                            <?php foreach ($jadwal_tayang_options as $option) : ?>
                                <option value="<?= $tiket['jadwal_tayang']; ?>" <?= set_select('jadwal_tayang', $option); ?>><?= $option; ?></option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <select class="form-control" id="kategori_tiket" name="kategori_tiket">
                            <?php foreach ($kategori_tiket_options as $option) : ?>
                                <option value="<?= $tiket['kategori_tiket']; ?>" <?= set_select('kategori_tiket', $option); ?>><?= $option; ?></option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-group mt-3">
                        ...
                        <input type="text" class="form-control" id="harga_tiket" name="harga_tiket" value="<?= $tiket['harga_tiket']; ?>">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <select class="form-control" id="metode_pembayaran" name="metode_pembayaran">
                                <?php foreach ($metode_pembayaran_options as $option) : ?>
                                    <option value="<?= $tiket['metode_pembayaran']; ?>" <?= set_select('metode_pembayaran', $option); ?>><?= $option; ?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="date" class="form-control" id="tanggal" name="tanggal" value="<?= $tiket['judul_film']; ?>">
